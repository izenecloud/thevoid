...
#ifndef IZENECLOUD_THEVOID_STREAM_HPP
#define IZENECLOUD_THEVOID_STREAM_HPP
 ...
 *
 * \code
namespace izenecloud { namespace thevoid {
template <>
...
public:
	 ...
	 * \code{.cpp}
	 * izenecloud::http_response response(type);
...
protected:
	/*!
	 * \brief Returns const reference to izenecloud::http_request associated initiated this handler.
	 */
...
#endif // IZENECLOUD_THEVOID_STREAM_HPP
